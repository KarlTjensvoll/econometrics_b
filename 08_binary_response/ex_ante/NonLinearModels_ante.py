...
def estimate(
    ...
    obj_func = None # Fill in. Use np.sum to sum the func input. It is also a good idea to scale it by 1/n.
    result = None # Fill in using the obj_func and theta0
...
def probit_criterion(beta, y, x):
    z = None  # Fill in the z, look at eq. (1)
    G = None  # Fill in the G() function, hint: use norm.cdf, as stated after eq. (1) 
    ...
    ll = None  # Fill out the likelihood contribution for the Probit model.
    return ll


def logit_criterion(beta, y, x):
    z = None  # Fill in the z, look at eq. (2)
    G = None  # Fill in the G() function, look at eq. (2) 
    ...
    ll = None  # Fill out the likelihood contribution for the Logit model.
    return ll
