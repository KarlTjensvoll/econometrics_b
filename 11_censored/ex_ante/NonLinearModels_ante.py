...
def estimate(
    ...
    obj_func = lambda theta: -np.mean(func(theta, y, x))
...
def tobit_criterion(theta, y, x):
    ...
    # FILL IN: First, calculate the dot product of x and beta
    # FILL IN: Then calculate the residual using y and the dot product of x and beta
    ...
    ll =  # FILL IN: Finish the criterion function eq. (6)
    return ll
